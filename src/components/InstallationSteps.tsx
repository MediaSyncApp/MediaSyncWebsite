          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-6">
              ...
              <a
                ...
                className="inline-flex justify-center items-center gap-2 px-4 py-2 rounded-lg bg-primary hover:bg-primary/90 transition-colors text-sm font-medium text-black"
              >
